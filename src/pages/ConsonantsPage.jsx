              ...
              <Card key={c.l + c.name} className="rounded-none shadow-none">
                <CardContent className="flex flex-col items-center text-center gap-0.5 p-2">
                  ...
                  <div className="flex items-center gap-1.5 mt-1 pt-1 border-t border-border w-full justify-center">
                    ...
                    <span className="font-thai-noto-sans text-base text-muted-foreground leading-none">{c.l}</span>
                    <span className="font-thai-cursive text-base text-muted-foreground leading-none">{c.l}</span>
                  </div>
                </CardContent>
              </Card>
            ))}
