...
const FEATURES = [
  { stat: '313',    label: 'vocabulary flashcards', sub: 'across 18 topics' },
  { stat: '60',     label: 'grammar patterns',      sub: 'with examples'    },
  { stat: '24+',    label: 'reading passages',       sub: 'graded texts'     },
  { stat: '5',      label: 'interactive games',      sub: 'to drill faster'  },
];
  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
        {FEATURES.map(f => (
          <div key={f.stat} className="rounded-xl border border-border bg-card px-4 py-4 text-center">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-6">
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            Entirely optional, always appreciated. <span className="font-thai-display text-foreground">ขอบคุณครับ</span>
          </p>
        </div>
